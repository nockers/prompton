...
export class RequestMarkedAsCanceledByRecipientEvent
  extends PrototypeEvent
  implements Props
{
  static readonly type = "REQUEST_MARKED_AS_CANCELED_BY_RECIPIENT" as const

  get type() {
    return RequestMarkedAsCanceledByRecipientEvent.type
  }
